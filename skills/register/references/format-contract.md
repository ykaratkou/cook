# The task-set format contract

Verbatim copy of the contract section of `docs/spec/01-storage.md` (between its `format-contract` markers). Do not edit here; port changes from the spec — the parity drift-guard checks this copy every porting session.
